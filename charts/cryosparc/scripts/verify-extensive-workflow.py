...
job_uid = cli.do_job(job_type='extensive_workflow_bench', puid=project_uid, wuid=workspace_uid, uuid=user_id, params={'dataset_data_dir': '/cryosparc_projects/data/EMPIAR/10025/data/empiar_10025_subset'})
